...
import { MdDeliveryDining, MdFavorite, MdHelp } from "react-icons/md";
  ...
  return (
    <nav className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
      <div className="flex items-center">
        <div className="cursor-pointer mt-1" onClick={() => setNav(!nav)}>
        ...
        <nav>
          <ul className="flex flex-col p-4 text-gray-800">
            <li className="text-xl py-4 flex">
              <MdDeliveryDining size={25} className="mr-4 " />
              Orders
            </li>
            <li className="text-xl py-4 flex">
